...
```
Below shows the raw machine code of this boot sector.
These are the actual bytes that are telling the CPU exactly what to do. 
```
b4 0 e b0 48 cd 10 b0 65 cd 10 b0 6c cd 10 b0 6 c
